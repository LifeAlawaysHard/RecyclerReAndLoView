...
public class TitleMainActivity extends AppCompatActivity {
    ...
    private ArrayList<ArrayList<String>> datass = new ArrayList<>();
    private TitleAdapter<String> adapter;
...
//            }
//        };
        adapter = new MyTitleAdapter(this, titlelist, datass);
            ...
            public void onRefresh() {
                ...
                new Handler().post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        ObjectAnimator animator = ObjectAnimator.ofFloat(iv, "rotation", 0f,
                                720f, 0f);
